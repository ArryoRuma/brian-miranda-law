    ...
    <div className="site-shell">
      ...
      <main id="top">
        <section className="hero-section">
          <div className="hero-copy">
            <p className="eyebrow">
              <span className="eyebrow-rule" /> Estate planning, thoughtfully
              handled
            </p>
            <h1>
              Plan with clarity.
            ...
            <p className="hero-lede">
              A considered approach to the documents, decisions, and
              conversations that help protect what matters most.
            </p>
            ...
            <p className="hero-note">
              <ShieldCheck size={15} /> Clear guidance for the people and future
              you care about.
            </p>
          </div>
        ...
        <section className="intro-section" id="approach">
          ...
          <div className="intro-content">
            <p className="eyebrow dark">
              <span className="eyebrow-rule" /> A steady hand for important
              decisions
            </p>
            <h2>
            ...
            <div className="intro-columns">
              ...
              <p>
                Our work is centered on understanding your priorities, then
                shaping a plan that reflects them with care. No unnecessary
                complexity. No one-size-fits-all answers.
              </p>
            </div>
            <button
        ...
        <section className="services-section" id="services">
          <div className="section-heading-row">
            <div>
              <p className="eyebrow dark">
                <span className="eyebrow-rule" /> Focused counsel
              </p>
            ...
            {[
              {
                ...
                n: "01",
                title: "Wills & trusts",
                copy: "Thoughtful documents that express your wishes and help your loved ones move forward with clarity.",
              },
              {
                icon: Users,
                n: "02",
                title: "Family & legacy planning",
                copy: "A plan that accounts for the people, relationships, and responsibilities that make your family unique.",
              },
              {
                icon: Compass,
                n: "03",
                title: "Guidance through change",
                copy: "Review and refinement when life shifts, so your plan continues to reflect what matters now.",
              },
        ...
        <section className="quote-section">
          <div className="quote-offset">
            <span className="section-marker">
              03 <span>/</span> A guiding principle
            </span>
          ...
          <blockquote>
            “The best plans give people something more valuable than paperwork:{" "}
            <em>peace of mind.</em>”
          </blockquote>
        ...
        <section className="process-section" id="process">
          ...
          <div className="process-copy">
            <p className="eyebrow dark">
              <span className="eyebrow-rule" /> A clear way forward
            </p>
            <h2>
              Start where you are.
              <br />
              ...
              {[
                {
                  n: "01",
                  title: "Listen",
                  copy: "We begin with your priorities, questions, and the people you want to protect.",
                },
                {
                  n: "02",
                  title: "Shape",
                  copy: "We translate those priorities into a plan that is clear, cohesive, and built for real life.",
                },
                {
                  n: "03",
                  title: "Carry forward",
                  copy: "You leave with documents you understand and a plan you can return to as life changes.",
                },
              ].map(step => (
        ...
        <section className="faq-section">
          <div className="faq-intro">
            <p className="eyebrow">
              <span className="eyebrow-rule" /> A few first questions
            </p>
          ...
          <div className="faq-list">
            {[
              ...
              "Can you help my family understand the documents?",
            ].map((q, i) => (
              <div
                className={openFaq === i ? "faq-item is-open" : "faq-item"}
                key={q}
              >
                ...
                {openFaq === i && (
                  <p>
                    There is no single right moment. A first conversation is
                    simply a way to understand what you have in place, what has
                    changed, and what you may want to consider next.
                  </p>
                )}
              </div>
            ))}
        ...
        <section className="contact-section" id="contact">
          <div className="contact-inner">
            <div>
              <p className="eyebrow">
                <span className="eyebrow-rule" /> The next step can be simple
              </p>
              <h2>Let’s make a thoughtful plan.</h2>
              <p className="contact-lede">
                Tell us a little about what brings you here. We will be in touch
                to arrange a private introductory conversation.
              </p>
            </div>
      ...
      <footer className="site-footer">
        <div className="footer-brand">
          ...
          <span>
            <strong>Brian Miranda</strong>
            <em>Law</em>
          </span>
        </div>
        <p>Estate planning, thoughtfully handled.</p>
        <div className="footer-meta">
          <span>© 2026 Brian Miranda Law</span>
          <span>Privacy</span>
